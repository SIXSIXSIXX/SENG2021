<%@ page language="java" contentType="text/html; charset=UTF-8"
	pageEncoding="UTF-8"%>
<%@ page import="java.util.*,dataBase.Makes,searchResult.SearchResult, dataBase.Model,api.PhotoApi"%>
...
<title>Insert title here</title>
	...
	<link rel="stylesheet" type="text/css" href="style/recommendationResult.css">
</head>
<body>
<%request.getSession().setAttribute("prevpage", "recommendationResult.jsp"); %>
<div id="header">
    <iframe src="header.jsp" height="200px" width="1366px" frameborder="0"></iframe>
</div>
<div class="txt">
	<h1>Recommendation Result for: //add content here</h1>
</div>
...
<div class="result">
		<ul class="title">
            ...
            <li style="font-size:27px">Rating</li>
