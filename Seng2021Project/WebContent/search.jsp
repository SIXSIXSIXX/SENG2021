...
<body>
<%request.getSession().setAttribute("prevpage", "search.jsp"); %>
<div id="header">
...
<div class="allcontain">
	...
	<%String modelVisibility ="hidden"; %>
    <nav class="navbar navbar-default midle-nav">
			<div  id="navbarmidle" style="padding-bottom:70px;">
				<div class="searchtxt" style="margin-top:30px;">
					<h1 style="font-size:35px;">SEARCH</h1>
				</div>
                <br>
			...
			%>	
				...
				<%
				if(((String)session.getAttribute("make"))!=null){if(((String)session.getAttribute("make")).equals(make)){ modelVisibility ="visible";%>
				selected="selected"
				<%}}%>
				><%=make%></option>
			...
			%>		
				...
				<%
				 String modType= "";if(((String)session.getAttribute("model"))!=null){
				modType = (String)session.getAttribute("model");
				
				}%>
                </li>

                
                <li id="model" style="padding-top:0px;margin-top:0px;height:40px;width:200px">
					<input type="text" name="model" value ="<%=modType%>" class="form-control searchform" placeholder="MODEL">
                </li>
				</ul>
                <br><br><br><br>
                ...
                <li>
					...
					<%if(((String)session.getAttribute("transmission"))!=null){if(((String)session.getAttribute("transmission")).equals("AUTOMATIC")){%>
					selected="selected"
					<%}}%>
					>AUTOMATIC</option>

					<option value="MANUAL"
					<%if(((String)session.getAttribute("transmission"))!=null){if(((String)session.getAttribute("transmission")).equals("MANUAL")){%>
					selected="selected"
					<%}}%>
					>MANUAL</option>
			...
			%>
				...
				<%if(((String)session.getAttribute("body"))!=null){if(((String)session.getAttribute("body")).equals(body)){%>
				selected="selected"
				<%}}%>
				><%=body%></option>
			...
			%>
                ...
                <li>
					...
					<select class="form-control" name="driveType" id="publicationtype">
                    <option value="">DRIVE TYPE</option>
                    
					<option value="front wheel drive"
					<%if(((String)session.getAttribute("driven"))!=null){if(((String)session.getAttribute("driven")).equals("front wheel drive")){%>
					selected="selected"
					<%}}%>
					>FRONT WHEEL DRIVE</option>
					
					<option value="rear wheel drive"
					<%if(((String)session.getAttribute("driven"))!=null){if(((String)session.getAttribute("driven")).equals("rear wheel drive")){%>
					selected="selected"
					<%}}%>
					>REAR WHEEL DRIVE</option>
					
					<option value="four wheel drive"
					<%if(((String)session.getAttribute("driven"))!=null){if(((String)session.getAttribute("driven")).equals("four wheel drive")){%>
					selected="selected"
					<%}}%>
					>FOUR WHEEL DRIVE</option>
					
					<option value="all wheel drive"
					<%if(((String)session.getAttribute("driven"))!=null){if(((String)session.getAttribute("driven")).equals("all wheel drive")){%>
					selected="selected"
					<%}}%>
				...
				<%
					int min = 0;
					int max = 1000000;
					if(((Integer)session.getAttribute("min"))!=null){
                ...
                <%String currPrice= "";if(((String)session.getAttribute("price"))!=null){currPrice = (String)session.getAttribute("price");  System.out.println("price= "+currPrice);}%>
					<li class="li-slideprice">
						<p> <label class="slidertxt" for="amount">Price </label>
							<input class="priceslider" name="price" type="text" id="amount" readonly>
							<div id="slider-range" name = "range"></div>

					</li>
					<li class="li-search"> <button class="searchbutton" id="submit" name ="search"><span class="glyphicon glyphicon-search "></span></button></li>
					</ul>
